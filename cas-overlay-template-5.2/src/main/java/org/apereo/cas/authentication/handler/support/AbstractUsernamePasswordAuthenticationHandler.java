...
public abstract class AbstractUsernamePasswordAuthenticationHandler extends AbstractPreAndPostProcessingAuthenticationHandler {
    ...
    protected HandlerResult doAuthentication(final Credential credential) throws GeneralSecurityException, PreventedException {
        ...
        userPass.setCompany(originalUserPass.getCompany());
        if(StringUtils.isBlank(originalUserPass.getCompany())) {
            throw new AccountNotFoundException("Company is null.");
        }
        ...
        userPass.setAuthcode(originalUserPass.getAuthcode());
